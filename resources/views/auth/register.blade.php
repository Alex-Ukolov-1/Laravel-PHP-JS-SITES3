...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-3 mb-3">
            <h4 style="text-align: center;margin-bottom: 20px;">Внимание! Регистрация водителей ТС производится через существующую учётную запись компании в разделе &laquo;Водители&raquo;</h4>
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right required">Название организации <span class="text-danger">*</span></label>
        ...
        <footer style="position: absolute;bottom: 0;left:0;right:0;text-align: center;">
            <h6>Регистрируясь и используя систему CASH TRIP, вы соглашаетесь с <a href="{{route('license')}}">Лицензионным соглашением</a>,
                <a href="{{route('agreement')}}">Соглашением об использовании сайта</a>, и <a href="{{route('privacy')}}">Политикой конфиденциальности</a>
            </h6>
            <h6>&copy; 2020-{{date('Y')}} | Все права защищены. При использовании любых материалов ссылка на cashtrip.ru обязательна.</h6>
        </footer>
    </div>
</div>
@endsection
